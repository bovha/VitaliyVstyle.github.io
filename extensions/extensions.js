...
win.document.write("<html><head><title>Adds Toolbar and Buttons</title><link rel='shortcut icon' href='/contentimages/AddsToolbarandButtons.png'  sizes='16x16' type='image/png'>" + style_Sheets + "</head><body><div><img src='/contentimages/AddsToolbarandButtons.png' border='0'><strong>Adds Toolbar and Buttons</strong></div><br><div><button onclick='install();'>Установить</button>  <button onclick='download()'>Загрузить</button></div><" + "script type='text/javascript'>function install() {InstallTrigger.install({'Adds Toolbar and Buttons': {URL: 'https://vitaliyvstyle.github.io/extensions/adds_toolbar_and_buttons-2.1.0-fx-sm.xpi', IconURL: '/contentimages/AddsToolbarandButtons.png'}}); Request('adds_toolbar_and_buttons-2.1.0-fx-sm.xpi');} function download() {window.open('https://github.com/VitaliyVstyle/VitaliyVstyle.github.io/raw/master/extensions/adds_toolbar_and_buttons-2.1.0-fx-sm.xpi', '_self'); Request('adds_toolbar_and_buttons-2.1.0-fx-sm.xpi');} " + XML_Http_Request + "</" + "script></body></html>");
win.document.close();
}
