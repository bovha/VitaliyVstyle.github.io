...
win.document.open();
win.document.writeln("<!DOCTYPE html>");
win.document.write("<html><head><title>eCleaner</title><link rel='shortcut icon' href='/contentimages/eCleaner.png'  sizes='16x16' type='image/png'>" + style_Sheets + "</head><body><div><img src='/contentimages/eCleaner.png' border='0'><strong>eCleaner</strong></div><br><div><button onclick='install();'>Установить</button>  <button onclick='download()'>Загрузить</button></div><" + "script type='text/javascript'>function install() {InstallTrigger.install({'eCleaner': {URL: 'https://vitaliyvstyle.github.io/extensions/ecleaner-2.6.5-fx-sm-tb.xpi', IconURL: '/contentimages/eCleaner.png'}}); Request('ecleaner-2.6.5-fx-sm-tb.xpi');} function download() {window.open('https://github.com/VitaliyVstyle/VitaliyVstyle.github.io/raw/master/extensions/ecleaner-2.6.5-fx-sm-tb.xpi', '_self'); Request('ecleaner-2.6.5-fx-sm-tb.xpi');} " + XML_Http_Request + "</" + "script></body></html>");
win.document.close();
}
