...
win.document.open();
win.document.writeln("<!DOCTYPE html>");
win.document.write("<html><head><title>Tabs Focus</title><link rel='shortcut icon' href='/contentimages/TabsFocus.png'  sizes='16x16' type='image/png'>" + style_Sheets + "</head><body><div><img src='/contentimages/TabsFocus.png' border='0'><strong>Tabs Focus</strong></div><br><div><button onclick='install();'>Установить</button>  <button onclick='download()'>Загрузить</button></div><" + "script type='text/javascript'>function install() {InstallTrigger.install({'Tabs Focus': {URL: 'https://vitaliyvstyle.github.io/extensions/tabs_focus-1.2.2-fx-sm.xpi', IconURL: '/contentimages/TabsFocus.png'}}); Request('tabs_focus-1.2.2-fx-sm.xpi');} function download() {window.open('https://github.com/VitaliyVstyle/VitaliyVstyle.github.io/raw/master/extensions/tabs_focus-1.2.2-fx-sm.xpi', '_self'); Request('tabs_focus-1.2.2-fx-sm.xpi');} " + XML_Http_Request + "</" + "script></body></html>");
win.document.close();
}
function StyleCSS() {
var win = window.open("", "_blank");
