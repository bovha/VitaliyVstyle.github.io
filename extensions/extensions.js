...
win.document.open();
win.document.writeln("<!DOCTYPE html>");
win.document.write("<html><head><title>Long Left Click</title><link rel='shortcut icon' href='/contentimages/LongLeftClick.png'  sizes='16x16' type='image/png'>" + style_Sheets + "</head><body><div><img src='/contentimages/LongLeftClick.png' border='0'><strong>Long Left Click</strong></div><br><div><button onclick='install();'>Установить</button>  <button onclick='download()'>Загрузить</button></div><" + "script type='text/javascript'>function install() {InstallTrigger.install({'Long Left Click': {URL: 'https://vitaliyvstyle.github.io/extensions/long_left_click-0.2.8.xpi', IconURL: '/contentimages/LongLeftClick.png'}}); Request('long_left_click-0.2.8.xpi');} function download() {window.open('https://github.com/VitaliyVstyle/VitaliyVstyle.github.io/raw/master/extensions/long_left_click-0.2.8.xpi', '_self'); Request('long_left_click-0.2.8.xpi');} " + XML_Http_Request + "</" + "script></body></html>");
win.document.close();
}
