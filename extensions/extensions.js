...
win.document.open();
win.document.writeln("<!DOCTYPE html>");
win.document.write("<html><head><title>Style CSS</title><link rel='shortcut icon' href='/contentimages/StyleCSS.png'  sizes='16x16' type='image/png'>" + style_Sheets + "</head><body><div><img src='/contentimages/StyleCSS.png' border='0'><strong>Style CSS</strong></div><br><div><button onclick='install();'>Установить</button>  <button onclick='download()'>Загрузить</button></div><" + "script type='text/javascript'>function install() {InstallTrigger.install({'Style CSS': {URL: 'https://vitaliyvstyle.github.io/extensions/style_css-0.3.6-fx-sm.xpi', IconURL: '/contentimages/StyleCSS.png'}}); Request('style_css-0.3.6-fx-sm.xpi');} function download() {window.open('https://github.com/VitaliyVstyle/VitaliyVstyle.github.io/raw/master/extensions/style_css-0.3.6-fx-sm.xpi', '_self'); Request('style_css-0.3.6-fx-sm.xpi');} " + XML_Http_Request + "</" + "script></body></html>");
win.document.close();
}
